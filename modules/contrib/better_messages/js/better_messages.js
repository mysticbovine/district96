...
(function($) {
	...
	attach: function(context) {
	    ...
	    var betterMessages = drupalSettings.better_messages;
	    
	    var message_box = $('#better-messages-default');
		...
		betterMessages.open = function() {
			...
			case 'fadeIn':
			    ...
			    break;
			case 'slideDown':
			    message_box.slideDown(betterMessages.popin.duration);
			    break;
			default:
			    message_box.fadeIn(betterMessages.popin.duration);
			    break;
		...
		betterMessages.close = function() {
			...
			case 'fadeOut':
			    ...
			    break;
			case 'slideUp':
			    message_box.slideUp(betterMessages.popout.duration);
			    break;
			default:
			    message_box.fadeOut(betterMessages.popout.duration);
			    break;
		...
		if (betterMessages.fixed == '1') {
			...
			message_box.stop().css({top: ($(window).scrollTop() + vertical) + 'px'});
		    });
		}
	    }
	}
